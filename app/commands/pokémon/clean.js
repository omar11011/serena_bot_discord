...
class Command extends Base {
    ...
    constructor() {
        ...
        this.nombre = 'clean'
        this.cooldown = 60
        this.description = 'Dale un baño a tu pokémon para fortalecer el lazo de amistad entre ustedes dos.'
        this.uses = [
            ['Bañar a tu pokémon', ''],
        ]
        ...
        this.exec = async (message, args, server) => {
            ...
            return this.sendEmbed(message, { author: [message.author.tag, message.author.avatarURL()], description: pokemon.pokemon + ' se siente mejor después del baño, la amistad entre ustedes se ha incrementado en +1 punto.' })
        }
    }
}
